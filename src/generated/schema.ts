import { ColorBucketType } from 'keep';
import { FaviconType } from 'keep';
import { ImgixParamsAuto } from 'keep';
import { ImgixParamsBlendAlign } from 'keep';
import { ImgixParamsBlendCrop } from 'keep';
import { ImgixParamsBlendFit } from 'keep';
import { ImgixParamsBlendMode } from 'keep';
import { ImgixParamsBlendSize } from 'keep';
import { ImgixParamsCh } from 'keep';
import { ImgixParamsCrop } from 'keep';
import { ImgixParamsCs } from 'keep';
import { ImgixParamsFill } from 'keep';
import { ImgixParamsFit } from 'keep';
import { ImgixParamsFlip } from 'keep';
import { ImgixParamsFm } from 'keep';
import { ImgixParamsIptc } from 'keep';
import { ImgixParamsMarkAlign } from 'keep';
import { ImgixParamsMarkFit } from 'keep';
import { ImgixParamsMarkTile } from 'keep';
import { ImgixParamsPalette } from 'keep';
import { ImgixParamsTransparency } from 'keep';
import { ImgixParamsTrim } from 'keep';
import { ImgixParamsTxtAlign } from 'keep';
import { ImgixParamsTxtClip } from 'keep';
import { ImgixParamsTxtFit } from 'keep';
import { ItemStatus } from 'keep';
import { MuxThumbnailFormatType } from 'keep';
import { ProductModelOrderBy } from 'keep';
import { ResolutionType } from 'keep';
import { SiteLocale } from 'keep';
import { UploadOrderBy } from 'keep';
import { UploadOrientation } from 'keep';
import { UploadType } from 'keep';
import { VideoMp4Res } from 'keep';
...
export type HomepageRecord = {
  ...
  _unpublishingScheduledAt: Maybe<Scalars['DateTime']>;
  _updatedAt: Scalars['DateTime'];
  aboutBanner: Maybe<FileField>;
  aboutSideText: Maybe<Scalars['String']>;
...
/** Record of type Homepage (homepage) */
export type HomepageRecordAboutSideTextArgs = {
  markdown: InputMaybe<Scalars['Boolean']>;
};


/** Record of type Homepage (homepage) */
export type HomepageRecordAboutTextArgs = {
  markdown: InputMaybe<Scalars['Boolean']>;
};


/** Record of type Homepage (homepage) */
export type HomepageRecordOpeningHoursArgs = {
  markdown: InputMaybe<Scalars['Boolean']>;
};
...
export { ImgixParamsAuto };

export { ImgixParamsBlendAlign };

export { ImgixParamsBlendCrop };

export { ImgixParamsBlendFit };

export { ImgixParamsBlendMode };

export { ImgixParamsBlendSize };

export { ImgixParamsCh };

export { ImgixParamsCrop };

export { ImgixParamsCs };

export { ImgixParamsFill };

export { ImgixParamsFit };

export { ImgixParamsFlip };

export { ImgixParamsFm };

export { ImgixParamsIptc };

export { ImgixParamsMarkAlign };

export { ImgixParamsMarkFit };

export { ImgixParamsMarkTile };

export { ImgixParamsPalette };

export { ImgixParamsTransparency };

export { ImgixParamsTrim };

export { ImgixParamsTxtAlign };

export { ImgixParamsTxtClip };

export { ImgixParamsTxtFit };
...
export type ProductModelFilter = {
  ...
  hasBlackout: InputMaybe<BooleanFilter>;
  hasTranslucid: InputMaybe<BooleanFilter>;
  id: InputMaybe<ItemIdFilter>;
  intro: InputMaybe<TextFilter>;
  isAutomated: InputMaybe<BooleanFilter>;
  mechanism: InputMaybe<StringFilter>;
...
export type ProductRecord = {
  ...
  hasBlackout: Maybe<Scalars['BooleanType']>;
  hasTranslucid: Maybe<Scalars['BooleanType']>;
  id: Scalars['ItemId'];
  intro: Maybe<Scalars['String']>;
  isAutomated: Maybe<Scalars['BooleanType']>;
...
/** Record of type Produto (product) */
export type ProductRecordIntroArgs = {
  markdown: InputMaybe<Scalars['Boolean']>;
};
...
export { UploadOrderBy };

export { UploadOrientation };
...
export type ProductSlugs = { allProducts: Array<{ slug: string | null | undefined }> };

export type ProductPageVariables = Exact<{
  slug: InputMaybe<Scalars['String']>;
}>;


export type ProductPage = { product: { id: any, title: string | null | undefined, description: string | null | undefined, slug: string | null | undefined, isAutomated: any | null | undefined, hasBlackout: any | null | undefined, hasTranslucid: any | null | undefined, gallery: Array<{ url: string, responsiveImage: { src: string, srcSet: string, webpSrcSet: string, sizes: string, alt: string | null | undefined, width: any, height: any } | null | undefined }> } | null | undefined };
