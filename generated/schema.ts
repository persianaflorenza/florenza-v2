...
export enum ProductModelOrderBy {
  ...
  hasBlackout_ASC = 'hasBlackout_ASC',
  hasBlackout_DESC = 'hasBlackout_DESC',
  hasTranslucid_ASC = 'hasTranslucid_ASC',
  hasTranslucid_DESC = 'hasTranslucid_DESC',
  id_ASC = 'id_ASC',
  id_DESC = 'id_DESC',
  isAutomated_ASC = 'isAutomated_ASC',
  isAutomated_DESC = 'isAutomated_DESC',
  mechanism_ASC = 'mechanism_ASC',
